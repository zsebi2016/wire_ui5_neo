sap.ui.define([
	...
	return BaseController.extend("sapneo.my.wire.wire_ui5_neo.controller.TeamDetail", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		onInit: function () {
			...
			this.getRouter().getRoute("TeamDetail").attachPatternMatched(this._onObjectMatched, this);
